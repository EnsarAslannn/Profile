...
export default function Resume() {
  return (
    <section id="ozgecmis" className="scroll-mt-20 border-t border-line-subtle py-16">
          ...
          <div key={group.id}>
            ...
            <ul className="mt-5 space-y-5">
              {group.entries.map((entry) => (
                <li
                  key={entry.id}
                  className="flex flex-col gap-1 border-b border-line-subtle pb-5 last:border-b-0 last:pb-0 sm:flex-row sm:items-baseline sm:justify-between sm:gap-6"
                >
